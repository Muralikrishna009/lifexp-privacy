        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mt-8">
            ...
            <div className="mt-4 bg-blue-50 p-6 rounded-lg shadow">
              ...
              <p className="mt-2 flex items-center text-lg text-gray-900"><span className="mr-2 text-2xl">🗑️</span> You can request complete data deletion by contacting <a href="mailto:lifexp.updates@gmail.com" className="text-blue-600 hover:text-blue-800">lifexp.updates@gmail.com</a></p>
            </div>
          </section>
          ...
          <section className="mt-8">
            ...
            <div className="mt-4 bg-gray-50 p-6 rounded-lg shadow">
              <p className="flex items-center text-lg text-gray-900">
                ...
                Email: <a href="mailto:lifexp.updates@gmail.com" className="ml-2 text-blue-600 hover:text-blue-800">lifexp.updates@gmail.com</a>
              </p>
            </div>
          </section>
        </div>
